# ML_inv_eigenvalue
**Scripts for the paper "Application of machine learning regression models to inverse eigenvalue problems"**, https://arxiv.org/abs/2212.04279 (to appear in Computers & Mathematics with Applications)
